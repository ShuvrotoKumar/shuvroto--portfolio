        ...
        <Column classNames="w-full items-center justify-center">
          <div className="flex flex-col items-center justify-center w-full text-center">
            <div className="inline-flex items-center justify-center flex-wrap gap-2">
              <p className="text-2xl/normal sm:text-3xl/normal md:text-5xl/normal lg:text-6xl/normal xl:text-7xl/normal dark:text-[var(--textColor)] text-[var(--textColor)] font-bold">
                Hi there, I am
              </p>
              <div className="min-w-[200px] h-[1.2em] flex items-center justify-center">
                <FlipWords
                  words={["Shuvroto Kumar.", "@shuvroto."]}
                  className="text-2xl/normal sm:text-3xl/normal md:text-5xl/normal lg:text-6xl/normal xl:text-7xl/normal dark:text-[var(--primaryColor)] text-[var(--primaryColor)] font-bold"
                />
              </div>
            </div>
          </div>
          <p className="text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-[var(--textColorLight)]">
            Next.js Developer 💻 SDE 🛠️ Open Source 🌍
          </p>
