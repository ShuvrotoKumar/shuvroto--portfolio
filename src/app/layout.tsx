...
export const metadata: Metadata = {
  title: "Shuvroto Kumar",
  description:
    "Shuvroto is a proficient Software Engineer and Frontend Developer from Bangladesh, skilled in front-end using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  keywords: [
    ...
    "Shuvroto",
    "ShuvrotoKumar",
    "shuvroto kumar portfolio",
    "kumar shuvroto",
    "Shuvroto ex-CSE of BSMRSTU",
    "freelancer Shuvroto",
    "Frontend developer",
    "bd developer",
    "ShuvrotoKumar github",
    "sdks6409@gmail.com mail"
  ],
};
